...
\node (met) [operation, right of=a11, xshift= 1.5 cm] {metropolis criterion};
\node (q2) [question, right of=met, xshift= 2.5 cm] {solution accepted ?};
\node (a21) [answer, above of=q2, xshift=-1.5 cm, yshift= 0.7cm] {no};
\node (a22) [answer, above of=q2, xshift= 1.5 cm, yshift= 0.7cm] {yes};
...
\node (newNewSol) [result, above of=lcExp, xshift= 2.7 cm] {new solution};
...
\node (stop) [finalOperation, right of=a32, xshift= 1.5 cm] {best solution found so far};
...
\draw [arrow] (met) -- (q2);
\draw [arrow] (q2) -- (a21);
\draw [arrow] (a21) -- (lcExp);
\draw [arrow] (q2) -- (a22);
\draw [arrow] (a22) -- (newRandom);
\draw [arrow] (q1) -- (a12);
\draw [arrow] (a12) -- (lcExp);
\draw [arrow] (lcExp) -- (newNewSol);
\draw [arrow] (newRandom) -- (newNewSol);
\draw [arrow] (newNewSol) -- (q3);
\draw [arrow] (q3.north) -- (a31.south);
